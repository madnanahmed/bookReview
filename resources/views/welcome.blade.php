...
<body
    ...
    <div id="chatbot-container" class="fixed bottom-6 right-6 z-50">
        <button id="chatbot-toggle"
            class="p-4 bg-indigo-600 text-white rounded-full shadow-2xl hover:bg-indigo-700 transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-indigo-300">
            <svg id="chat-icon" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div id="chat-window"
            class="hidden absolute bottom-20 right-0 w-80 sm:w-96 bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-zinc-800 flex flex-col overflow-hidden transition-all duration-300 transform scale-95 opacity-0 origin-bottom-right">
            <!-- Header -->
            <div class="p-4 bg-indigo-600 text-white flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <p class="text-sm font-bold">BookReview Assistant</p>
                        <p class="text-[10px] text-indigo-100 uppercase tracking-widest font-black">Always here to help
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div id="chat-messages"
                class="flex-grow p-4 overflow-y-auto max-h-80 space-y-4 bg-indigo-50/30 dark:bg-zinc-900/50 min-h-[300px]">
                <div class="flex items-start">
                    <div
                        class="bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-200 p-3 rounded-2xl rounded-tl-none text-sm font-medium shadow-sm max-w-[85%]">
                        Hi there! 👋 Welcome to BookReview. How can I assist you today?
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 bg-white dark:bg-zinc-900 border-t border-gray-100 dark:border-zinc-800">
                <form id="chat-form" class="flex items-center space-x-2">
                    <input type="text" id="chat-input" placeholder="Type your message..."
                        class="flex-grow bg-gray-50 dark:bg-zinc-800 border-none rounded-xl px-4 py-2 text-sm focus:ring-2 focus:ring-indigo-500 dark:text-gray-200">
                    <button type="submit"
                        class="p-2 text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-lg transition-colors">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const appendMessage = (text, isUser = false) => {
                ...
                div.className = isUser ? 'chat-msg msg-user' : 'chat-msg msg-bot';
            ...
            form.addEventListener('submit', (e) => {
                ...
                // Show a typing indicator or just wait for the response
